<script lang="ts">
    ...
    import { getMyPendingApprovals, getActionableApprovals, castVote, type ProjectApproval } from '$lib/api';
    ...
    {:else}
        ...
        <section class="section">
            ...
            {#if myApprovals.length === 0}
                <div class="empty-state">
                    <p>{$_('approvals.no_pending_approvals', { default: 'You have no pending approvals.' })}</p>
                </div>
            {:else}
                <div class="approvals-grid">
                    {#each myApprovals as approval}
                        <div class="approval-card">
                            ...
                            <button
                                class="btn-secondary"
                                onclick={() => viewDetails(approval.id)}
                            >
        ...
        <section class="section">
            ...
            {#if actionableApprovals.length === 0}
                <div class="empty-state">
                    <p>{$_('approvals.no_actionable_approvals', { default: 'There are no approvals that need your vote.' })}</p>
                </div>
            {:else}
                <div class="approvals-grid">
                    {#each actionableApprovals as approval}
                        <div class="approval-card">
                            <div class="card-header">
                                <div>
