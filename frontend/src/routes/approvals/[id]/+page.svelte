                ...
                {#if approval.votes && approval.votes.length > 0}
                    <div class="votes-list">
                        {#each approval.votes as vote}
                            <div class="vote-card" class:approve={vote.vote === 'approve'} class:reject={vote.vote === 'reject'}>
                                ...
                                {#if vote.reason}
                                    <div class="vote-reason">
                                        <strong>{$_('approvals.reason', { default: 'Reason' })}:</strong> {vote.reason}
                                    </div>
                                {/if}
                            </div>
                        {/each}
            ...
            {#if approval.status === 'pending'}
                <div class="vote-form">
                    ...
                    <div class="form-group">
                        <label for="reason">{$_('approvals.reason_optional', { default: 'Reason (optional)' })}</label>
                        <textarea
                            id="reason"
                            bind:value={voteReason}
                            placeholder={$_('approvals.reason_placeholder', { default: 'Explain your decision...' })}
                            rows="3"
                        ></textarea>
                    </div>
